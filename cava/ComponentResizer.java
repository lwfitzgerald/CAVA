...
{
	private final static Dimension MINIMUM_SIZE = new Dimension(50, 10);
...
//	private Dimension maximumSize = new Dimension(300, 200);
	...
	private void validateMinimumAndInsets(Dimension minimum, Insets drag)
	{
		...
		{
			String message = "Minimum size cannot be less than drag insets " + minimum.height + " : " + minimumHeight;
